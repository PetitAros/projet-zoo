 ...
 */
final class Version20240110151941 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE famille_animal_habitat (famille_animal_id INT NOT NULL, habitat_id INT NOT NULL, INDEX IDX_A9F51DACAEBED700 (famille_animal_id), INDEX IDX_A9F51DACAFFE2D26 (habitat_id), PRIMARY KEY(famille_animal_id, habitat_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
